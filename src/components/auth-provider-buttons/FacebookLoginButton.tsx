...
import { useSignInWithRedirect, FacebookAuthProvider, UserCredential } from '@sprice237/react-auth';
...
export const FacebookLoginButton: VFC<FacebookLoginButtonProps> = ({
  onClick,
  onSuccess,
  onError,
}) => {
